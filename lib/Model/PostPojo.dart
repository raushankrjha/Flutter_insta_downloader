...
PostPojo postPojoFromJson(String str) => PostPojo.fromJson(json.decode(str));

String postPojoToJson(PostPojo data) => json.encode(data.toJson());
...
class PostPojo {
  ...
  factory PostPojo.fromJson(Map<String, dynamic> json) => PostPojo(
